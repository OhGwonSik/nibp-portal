    ...
    s.formatArr = function(e) {
        ...
        k.prototype.calendar = function(e, i, t) {
            ...
            d.firstDate || (d.firstDate = lay.extend({}, s)),
                ...
                lay.each(u, function(e, t) {
                    ...
                    (t = lay(t)).removeAttr("class"),
                        ...
                        d.rangeLinked || a + 1 === s.date && t.addClass(C)) : (a = e - o - l,
            ...
            a.range || (u = ["hours", "minutes", "seconds"],
                ...
                d.setBtnStatus(),
                lay(d.shortcut).find("li." + C).removeClass(C),
        ...
        k.prototype.stampRange = function() {
            ...
            l.range && !i.endState && lay(i.footer).find(L).addClass(M),
                ...
                lay.each(e, function(e, t) {
                    ...
                    a !== r && a !== n || (i.rangeLinked || !i.rangeLinked && (e < 42 ? a === r : a === n)) && lay(t).addClass(lay(t).hasClass(y) || lay(t).hasClass(m) ? o : C),
...
layui.define(["jquery", "laytpl", "lay", "util"], function(e) {
    ...
    }, v = "layui-dropdown", a = "layui-menu-item-up", d = "layui-menu-item-down", w = "layui-menu-body-title", s = "layui-menu-item-group", V = "layui-menu-item-parent", u = "layui-menu-item-checked", C = "layui-menu-item-checked2", x = "layui-menu-body-panel", b = "layui-menu-body-panel-left", T = "layui-dropdown-shade", k = "." + s + ">." + w, E = function(e) {
        var i = this;
        i.index = ++h.index,
    ...
    E.prototype.config = {
        ...
        E.prototype.init = function(e, i) {
            ...
            return 1 < a.length ? (layui.each(a, function() {
                ...
                !e && a[0] && a.data(y) ? (t = g.getThis(a.data(y))) ? t.reload(l, i) : void 0 : (l.elem = c(l.elem),
        ...
        E.prototype.render = function(e, i) {
            ...
            !(e = "contextmenu" !== d.trigger && !lay.isTopElem(d.elem[0]) ? e : !0) && d.elem.data(y + "_opened") || (a.elemView = c("." + v + "[" + f + '="' + d.id + '"]'),
                ...
                d.style && a.elemView.attr("style", d.style),
                    ...
                    e = d.shade ? '<div class="' + T + '" style="z-index:' + (a.elemView.css("z-index") - 1) + "; background-color: " + (d.shade[1] || "#000") + "; opacity: " + (d.shade[0] || d.shade) + '"></div>' : "",
                    a.elemView.before(e),
...
layui.define(["lay", "layer"], function(e) {
    ...
    var x = layui.$
        ...
        var i = this;
        i.index = ++s.index,
            i.config = x.extend({}, i.config, s.config, e),
            i.render()
    };
    z.prototype.config = {
        accept: "images",
        ...
        z.prototype.render = function(e) {
            ...
            return 1 < n.length ? (layui.each(n, function() {
                ...
                !e && n[0] && n.data(c) ? (e = o.getThis(n.data(c))) ? e.reload(t) : void 0 : (t.elem = x(t.elem),
        ...
        z.prototype.initIE = function() {
            var t, e = this.config, i = x('<iframe id="' + F + '" class="' + F + '" name="' + F + '" frameborder="0"></iframe>'), n = x(['<form target="' + F + '" class="' + r + '" method="post" key="set-mine" enctype="multipart/form-data" action="' + e.url + '">', "</form>"].join(""));
            x("#" + F)[0] || x("body").append(i),
            e.elem.next().hasClass(r) || (this.elemFile.wrap(n),
                e.elem.next("." + r).append((t = [],
        ...
        z.prototype.events = function() {
            var a = this
                ...
                a.isFile() || n.choose || t.after('<span class="layui-inline ' + w + '">' + e + "</span>")
            }
                , r = function(t) {
                var n = !0;
        ...
        s.util = {
            parseSize: function(e, i) {
                var t, n;
                return i = i || 2,
                    null != e && e ? (t = "string" == typeof e ? parseFloat(e) : e,
                        n = Math.floor(Math.log(t) / Math.log(1024)),
                    (e = (e = t / Math.pow(1024, n)) % 1 == 0 ? e : parseFloat(e.toFixed(i))) + ["Bytes", "Kb", "Mb", "Gb", "Tb", "Pb", "Eb", "Zb", "Yb"][n]) : "0"
            }
        },
        o.that = {},
                ...
                var i = this.config
                            ...
                            var r = T(this)
                                ...
                                "function" == typeof i.init && i.init.call(this, r, i),
                                    ...
                                    e.on("click", function() {
                                        ...
                                        T(this).hasClass(A) || ("function" == typeof i.click && i.click.call(this, r, i),
                    ...
                    select: function(e) {
                        var m, u = "\u8bf7\u9009\u62e9", g = "layui-form-select", b = "layui-select-title", x = "layui-select-none", k = "layui-select-create-option", C = "", e = e || a.find("select"), w = function(e, t) {
                            ...
                            var s, u, a, i, o, d, l, r = T(this), f = n.find("." + b), h = f.find("input"), y = n.find("dl"), p = (y.children("dd"),
                                y.children("dt")), v = this.selectedIndex;
                            e || (u = r.attr("lay-search"),
                                a = !(!lay.ie || "10" !== lay.ie && "11" !== lay.ie || !h.attr("placeholder")),
                                i = function() {
                                    ...
                                    e + t > j.height() && t <= e && n.addClass(g + "up"),
                                        d(),
                                    a && y.off("mousedown.select.ieph").on("mousedown.select.ieph", function() {
                                        h[0].__ieph = !0,
                                            setTimeout(function() {
                                                h[0].__ieph = !1
                                            }, 60)
                                        ...
                                        , r = (9 === e && o(),
                                            function(a, n) {
                                                ...
                                                var e = function() {
                                                    ...
                                                    , i = e[a]("dd:not(." + F + ")");
                                                return t[0] ? (s = e[a](),
                                                    i[0] && !i.hasClass(A) || !s[0] ? (i.addClass(_).siblings().removeClass(_),
                                                        void d()) : r(a, s)) : s = null
                                            }
                                    );
                                    38 === e && r("prev"),
                            ...
                            t && h.on("input propertychange", layui.debounce(function(e) {
                                ...
                                return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (a && e.target.__ieph ? e.target.__ieph = !1 : (l(i, function(e, t) {
                                    c ? t ? y.children("." + k).remove() : (t = y.children("." + k))[0] ? t.attr("lay-value", i).html(N.escape(i)) : ((t = T("<dd>")).addClass(k).attr("lay-value", i).html(N.escape(i)),
                                        y.append(t)) : e ? y.find("." + x)[0] || y.append('<p class="' + x + '">\u65e0\u5339\u914d\u9879</p>') : y.find("." + x).remove()
                                }, "keyup"),
                                "" === i && (r.val(""),
                                    y.find("." + _).removeClass(_),
                                (r[0].options[0] || {}).value || y.children("dd:eq(0)").addClass(_),
                                    y.find("." + x).remove(),
                                    c) && y.children("." + k).remove(),
                                    void d()))
                                ...
                                y.on("click", "dd", function() {
                                    ...
                                    return t.hasClass(A) || (t.hasClass("layui-select-tips") ? h.val("") : (h.val(t.text()),
                                        t.addClass(_)),
                                    c && t.hasClass(k) && (t.removeClass(k),
                        ...
                        e.each(function(e, t) {
                            ...
                            if ("string" == typeof i.attr("lay-ignore"))
                                return i.show();
                            var s, o = "string" == typeof i.attr("lay-search"), c = "string" == typeof i.attr("lay-creatable") && o, t = t && !t.value && t.innerHTML || u, r = T(['<div class="' + (o ? "" : "layui-unselect ") + g, n ? " layui-select-disabled" : "", (c ? " layui-select-creatable" : "") + '">', '<div class="' + b + '">', '<input type="text" placeholder="' + N.escape(T.trim(t)) + '" value="' + N.escape(T.trim(l ? r.html() : "")) + '"' + (!n && o ? "" : " readonly") + ' class="layui-input' + (o ? "" : " layui-unselect") + (n ? " " + A : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (i.find("optgroup")[0] ? " layui-select-group" : "") + '">', (t = i.find("*"),
                                s = [],
                            ...
                            0 === s.length && s.push('<dd lay-value="" class="' + A + '">\u6ca1\u6709\u9009\u9879</dd>'),
                            s.join("") + "</dl>"), "</div>"].join(""));
                            a[0] && a.remove(),
                                i.after(r),
                                d.call(this, r, n, o, c)
                    ...
                    radio: function(e) {
                        ...
                        e.each(function(e, t) {
                            ...
                            1 < s[0].attributes.length) && layui.each(s[0].attributes, function(e, t) {
                                ...
                                r = r.join(" "),
                                T(['<div class="layui-unselect ' + o, t.checked ? " " + o + "ed" : "", (n ? " layui-radio-disabled " + A : "") + '"', l ? ' lay-skin="' + l + '"' : "", ">", '<i class="layui-anim layui-icon ' + c[t.checked ? 0 : 1] + '"></i>', "<div " + r + ">" + a + "</div>", "</div>"].join("")));
                            i.after(s),
                                function(a) {
                                    var n = T(this)
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function(n) {
    ...
    var f = layui.$
        ...
        , C = function(e) {
        var t = w.that[e];
        return t || b.error(e ? "The table instance with ID '" + e + "' not found" : "ID argument required"),
        t || null
    }
        , l = function(e) {
        var t = w.config[e];
        ...
        , c = (i.prototype.config = {
            ...
            i.prototype.render = function(e) {
                ...
                a.index = t.index,
                    ...
                    a.height && /^full-.+$/.test(a.height) ? (t.fullHeightGap = a.height.split("-")[1],
                        a.height = r.height() - (parseFloat(t.fullHeightGap) || 0)) : a.height && /^#\w+\S*-.+$/.test(a.height) ? (i = a.height.split("-"),
                ...
                n.addClass((l = [L, L + "-" + t.index, "layui-form", "layui-border-box"],
                a.className && l.push(a.className),
                    ...
                    t.renderStyle(),
                i[0] && (t.resizeObserver && t.resizeObserver.unobserve(t.elem[0]),
                    i.remove()),
                    e.after(n),
            ...
            i.prototype.setInit = function(e) {
                ...
                d.css && -1 === d.css.indexOf(L) && (a = d.css.split("}"),
                ...
                var c = function(a, e, i, l) {
                    var n, o;
                    l ? (l.key = [d.index, a, i].join("-"),
                        l.colspan = l.colspan || 0,
                        l.rowspan = l.rowspan || 0,
                        r.initOpts(l),
                        (n = a + (parseInt(l.rowspan) || 1)) < d.cols.length ? (l.colGroup = !0,
                            o = 0,
            ...
            i.prototype.setColsWidth = function() {
                var t, a, n = this, r = n.config, i = 0, d = 0, c = 0, s = 0, u = n.setInit("width"), e = (n.eachCols(function(e, t) {
                        t.hide || i++
                    }),
                        u = u - ("line" === r.skin || "nob" === r.skin ? 2 : i + 1) - n.getScrollWidth(n.layMain[0]) - 1,
                        function(o) {
            ...
            i.prototype.pullData = function(a, t) {
                var e, i, l = this, n = l.config, o = (n.HAS_SET_COLS_PATCH || l.setColsPatch(),
                    ...
                    n.request), r = n.response, d = function() {
                ...
                "function" == typeof n.before && n.before(n),
                    ...
                    t.renderData ? ((e = {})[r.dataName] = k.cache[l.key],
                        e[r.countName] = n.url ? "object" === layui.type(n.page) ? n.page.count : e[r.dataName].length : n.data.length,
                    ...
                    n.contentType && 0 == n.contentType.indexOf("application/json") && (o = JSON.stringify(o)),
                        ...
                        f.ajax({
                            ...
                            success: function(e) {
                                (e = "function" == typeof n.parseData ? n.parseData(e) || e : e)[r.statusName] != r.statusCode ? l.errorView(e[r.msgName] || '\u8fd4\u56de\u7684\u6570\u636e\u4e0d\u7b26\u5408\u89c4\u8303\uff0c\u6b63\u786e\u7684\u6210\u529f\u72b6\u6001\u7801\u5e94\u4e3a\uff1a"' + r.statusName + '": ' + r.statusCode) : (l.totalRow = e[r.totalRowName],
                                    l.renderData({
                                        res: e,
                                        curr: a,
                                        count: e[r.countName],
            ...
            i.prototype.renderData = function(e) {
                ...
                return k.cache[a.key] = r,
                    a.layTotal[0 == r.length ? "addClass" : "removeClass"](y),
                    a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](D),
                    a.layPage.find(P)[!i.page || 0 == n || 0 === r.length && 1 == l ? "addClass" : "removeClass"](y),
                    0 === r.length ? a.errorView(i.text.none) : (a.layFixLeft.removeClass(D),
                        o ? u() : (u(),
                            a.renderTotal(r, t),
                ...
                c.totalRow && (layui.each(e, function(e, i) {
                    ...
                    d.eachCols(function(e, t) {
                        var a, e = t.field || e, i = o && o[t.field], l = "totalRowDecimals"in t ? t.totalRowDecimals : 2, l = s[e] ? parseFloat(s[e] || 0).toFixed(l) : "", l = (a = t.totalRowText || "",
                            ...
                            n = t.totalRow && T.call(d, {
                                item3: t,
                                content: l,
                                tplData: n
                            }) || a,
                        i || n), n = (t.field && d.dataTotal.push({
                            field: t.field,
            ...
            i.prototype.setRowChecked = function(i) {
                var e = this
                    ...
                    var a;
                    "array" === layui.type(t) || t[l.disabledName] || (n || (o ? -1 !== i.index.indexOf(e) : Number(i.index) === e) ? (a = t[l.checkName] = d(t[l.checkName]),
                        (e = r.filter('[data-index="' + e + '"]'))[a ? "addClass" : "removeClass"](_),
                    "radio" === i.type && e.siblings().removeClass(_)) : "radio" === i.type && delete t[l.checkName])
                }),
            ...
            i.prototype.sort = function(l) {
                ...
                "string" == typeof (l = l || {}).field && (r = l.field,
                ...
                try {
                    var r = r || l.field.data("field")
                        , d = l.field.data("key");
                    if (t.sortKey && !l.pull && r === t.sortKey.field && l.type === t.sortKey.sort)
                        return;
                ...
                i.autoSort && ("asc" === l.type ? e = layui.sort(o, r, null, !0) : "desc" === l.type ? e = layui.sort(o, r, !0, !0) : (e = layui.sort(o, k.config.indexName, null, !0),
                    delete t.sortKey,
                    delete i.initSort)),
            ...
            i.prototype.fullSize = function() {
                ...
                i.fullHeightGap ? (l = r.height() - i.fullHeightGap) < 135 && (l = 135) : i.parentDiv && i.parentHeightGap ? (l = f(i.parentDiv).height() - i.parentHeightGap) < 135 && (l = 135) : i.customHeightFunc && (l = i.customHeightFunc()) < 135 && (l = 135),
            ...
            i.prototype.scrollPatch = function() {
                ...
                e.layFixed.find(E).css("height", t.height() >= n ? n : "auto").scrollTop(e.layMain.scrollTop()),
                    e.layFixRight[k.cache[e.key] && k.cache[e.key].length && 0 < l ? "removeClass" : "addClass"](D),
                ...
                layui.each(e, function(e, t) {
                    ...
                    a = t.index,
                        ...
                        d.eachCols(function(e, t) {
                            ...
                            (i in l || ("function" == typeof n ? n(i, e) : n) && (t.templet || t.toolbar)) && (i = (e = r.children('td[data-field="' + i + '"]')).children(c),
                                a = o[t.field],
                                i.html(T.call(d, {
                                    item3: t,
                                    content: a,
            ...
            i.prototype.events = function() {
                var c = this
                    ...
                    , o = f("body")
                    , r = {}
                    , d = (c.layTool.on("click", "*[lay-event]", function(e) {
                        ...
                        switch (layui.stope(e),
                            ...
                            case "LAYTABLE_PRINT":
                                ...
                                d.append(c.layMain.find("table").html()),
                                    ...
                                    d.find("thead>tr>th." + H).filter(function(e, t) {
                        ...
                        e.on("mousemove", function(e) {
                            var t = f(this)
                                , a = t.offset().left
                                , e = e.clientX - a;
                            t.data("unresize") || w.eventMoveElem || (r.allowResize = t.width() - e <= 10,
                                o.css("cursor", r.allowResize ? "col-resize" : ""))
                        }).on("mouseleave", function() {
                            f(this);
                            w.eventMoveElem || (r.allowResize = !1,
                                o.css("cursor", ""))
                        }).on("mousedown", function(e) {
                            var t, a = f(this);
                    ...
                    w.docEvent || z.on("mousemove", function(e) {
                        var t, a;
                        w.eventMoveElem && (t = w.eventMoveElem.data(F) || {},
                        ...
                        var t, a, i, l, n;
                        w.eventMoveElem && (i = (t = w.eventMoveElem).closest("." + L).attr(R),
                            a = C(i)) && (i = t.data("key"),
                            l = a.col(i),
                    ...
                    , a = (c.elem.on("click", 'input[name="layTableCheckbox"]+', function(e) {
                        ...
                        t[0].disabled || (n ? c.setRowChecked({
                            ...
                            layui.stope(e)),
                            layui.event.call(t[0], N, "checkbox(" + u + ")", d.call(t[0], {
                                checked: l,
                                type: n ? "all" : "one",
                                getCol: function() {
                    ...
                    (e = f(e)).data("off") || (l = e.data("field"),
                        ...
                        a = k.cache[c.key][a],
                        e.children(y),
                    (i = "function" == typeof i.edit ? i.edit(a) : i.edit) && ((i = f("textarea" === i ? '<textarea class="layui-input ' + M + '" lay-unrow></textarea>' : '<input class="layui-input ' + M + '" lay-unrow>'))[0].value = (l = e.data("content") || a[l]) === undefined || null === l ? "" : l,
                    ...
                    , h = (c.layBody.on("click", "." + i, function(e) {
                        ...
                        function(e) {
                            ...
                            c.setRowActive(i),
                                layui.event.call(this, N, (e || "tool") + "(" + u + ")", d.call(this, {
            ...
            k.init = function(i, o) {
                ...
                return e.each(function() {
                    var l, e = f(this), t = e.attr("lay-data"), t = d.options(this, {
    ...
    k.eachCols = function(e, a, i) {
        ...
        k.exportFile = function(e, t, a) {
            ...
            var o, r, i, d, l = (a = "object" == typeof a ? a : (l = {},
            a && (l.type = a),
            ...
            if (x.ie)
                return b.error("IE_NOT_SUPPORT_EXPORTS");
            ...
            u.href = "data:" + s + ";charset=utf-8,\ufeff" + encodeURIComponent((o = [],
                ...
                layui.each(t, function(i, l) {
                    ...
                    "object" == typeof e ? (layui.each(e, function(e, t) {
                        ...
                        var a;
                        !1 === t.ignoreExport || t.field && "normal" == t.type ? t.hide && !1 !== t.ignoreExport || !0 === t.ignoreExport ? 0 == i && (d[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""),
                        0 == i && o.push(t.fieldTitle || t.title || t.field || ""),
                            ...
                            n.push(a = '"' + a + '"')) : t.field && "normal" !== t.type && 0 == i && (d[t.field] = !0)
                    }),
                        r.push(n.join(","))
                }),
...
layui.define(["table"], function(e) {
    ...
    var A = layui.$
        ...
        e && (!u || u.mod) || (a.done = function() {
            ...
            ,
            a.done.mod = !0),
        a && a.tree && a.tree.view && layui.each(p, function(e, t) {
    ...
    var r, U = function(e, t, a) {
        ...
        return h
            ...
            B.removeNode = function(e, t) {
                var a = j(e);
                if (a) {
                    var n, i = a.getOptions(), l = i.tree, d = l.customName.isParent, r = l.customName.children, o = i.elem.next(), c = [], u = P.cache[e], t = a.getNodeDataByIndex("string" === layui.type(t) ? t : t[z], !1, "delete"), s = a.getNodeDataByIndex(t[f]), l = (a.updateCheckStatus(s),
                        a.treeToFlat([t], t[l.customName.pid], t[f])), t = (layui.each(l, function(e, t) {
                        t = t[z];
                        c.push('tr[lay-data-index="' + t + '"]'),
                        -1 !== t.indexOf("-") && delete u[t]
                    }),
                        o.find(c.join(",")).remove(),
                        a.initData());
                    for (n in u)
                        -1 !== n.indexOf("-") && n !== u[n][z] && delete u[n];
                    ...
                    i.hasNumberCol && v(a),
                    s && (l = o.find('tr[lay-data-index="' + s[z] + '"]'),
                        s[d] = !(!s[r] || !s[r].length),
                        a.updateNodeIcon({
                            scopeEl: l,
                            isExpand: s[H],
    ...
    B.on("checkbox", function(e) {
        ...
        B.setRowChecked = function(a, e) {
            ...
            c && (t = c.getOptions().elem.next(),
                ...
                o.push(e),
                t.find('tr[lay-data-index="' + e + '"]').length || (e = c.getNodeDataByIndex(e)[f]) && l(e)
            }
                ,
            (d = t.find('tr[lay-data-index="' + i + '"]')).length || (r = r[f],
                o = [],
                l(r),
    ...
    l.prototype.load = function(o) {
        ...
        if (g[0])
            return c = v(o.scrollElem || document),
                ...
                p = v('<div class="layui-flow-more"><a href="javascript:;">' + (u = "<cite>\u52a0\u8f7d\u66f4\u591a</cite>") + "</a></div>"),
            ...
            e && c.on("scroll.flow", function() {
                var e = v(this)
                    , t = e.scrollTop();
                l && clearTimeout(l),
                !n && g.width() && (l = setTimeout(function() {
        ...
        l.prototype.lazyimg = function(o) {
            var l, m = this, a = 0, f = v((o = o || {}).scrollElem || document), s = o.elem || "img", n = "top" === (o.direction || "bottom"), u = o.scrollElem && o.scrollElem !== document, p = function(l, o) {
